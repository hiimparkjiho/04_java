...
public class Application2 {
    public static void main(String[] args){
        ...
        * 예) 앞에서 사용한 int 자료형은 정수 4byte 만큼을 읽어서 하나의 값으로 취급하겠다는 약소이다.
        ...
        * 그 공간에 대입 연산자를 이용하여 자료형에 저장하기로 한 형태의 값을 저장할 수 잇다.
...
//        fnum = 4.0; // 실수 형태의 값을 fnum에 사용하는 것은 불가능하다.
        ...
        * 일반적으로 사용하는 값을 독특한 형태가 아닌 일반적인 형태로 사용할 수 잇는 자료형을 대표자료형이라고 하며
