package source.src.main.java.com.ohgiraffers.section07.kindofvariable;
...
public class KindOfVariable {
    ...
    * */
    ...
    // non-static filed를 인스턴스 변수라고 한다.

    private int globalNum;

    // static filed를 정적필드(클래스 변수)라고 한다. (정적(클래스) 영역에 생성되는 변수라는 의미다..
    ...
    private void testMethod(int num){
        ...
        * */
        ...
        //System.out.println(localNum); //지역변수는 반드시 초기화해주어야 한다.
