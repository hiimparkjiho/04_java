package source.src.main.java.com.ohgiraffers.section05.overloading;
...
public class OverloadingTest {
    ...
    public static void main(String[] args){
        /*
        * 오버로딩의 사용
        * 매개변수의 종류별로 메소드의 내용을 다르게 작성해야 하는 경우들이 종종있다.
        ...
        *
        * 오버로딩의 조건
        * 동일한 이름을 가진 메소드의 파라미터 선언부에 매개변수의 타입, 갯수, 순서를 다르게 작생하여 한 클래스 내에 동일한 이름의 메소드를 여러 개
        * 작성할 수 있도록 한다.
