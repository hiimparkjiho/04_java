...
public class Application01 {
    public static void main(String[] args){
        ...
        * 3. Map 인터페이스
        *
        * list 인터페이스와 set 인터페으스의 공통 부분을 collection 인터페이스에서 정의하고 있다.
        * 하지만 Map 구조상 차이로 Collection 인터페이스에서 정의하고 있지 않다.
        *
        * 각 인터페이스 별 특징
        * 1. list 인터페이스
        ...
        * 크기 변경(새로운 더 큰 배열을 만들고 옭기기), 요소의 추가, 삭제, 정렬 기능들을 미리 메소드로 구현하여 제공한다.
        ...
        * */
        ...
        //stringList.add(String.valueOf(12345));
        ...
        * hasNext(): 다른 요소를 가지고 있는 경우 true, 더 이상 요소가 없는 경우 false
        * next(): 다음 요소를 반환.
        * */
        Iterator<String> dIter = ((LinkedList) stringList).descendingIterator();
//        while ((dIter.hasNext())){
//            System.out.println(dIter.next());
//        }
//
//        while ((dIter.hasNext())){  // Iterator를 한 번 사용했기에 다시 반환하지 않는다.
//            System.out.println(dIter.next());
//        }
