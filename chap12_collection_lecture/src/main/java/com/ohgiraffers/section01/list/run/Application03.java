...
public class Application03 {
    public static void main(String[] args){
        /*
        * linkedList
        * ArrayList가 배열을 이용해서 발생할 수 있는 성능적인 단점을 보완하고 고안되었다.
        ...
        * 하지만 단일 연결 리스트는 다음 요소만 링크하기 때문에 요소로 접근하기 어렵다는 단점이 있으며
        ...
        * */
        ...
        // IndexOfBoundsException 에러를 발생시키게 된다.
        //linkedList.set(8, "strawbarry");
