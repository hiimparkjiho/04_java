...
import main.java.com.ohgiraffers.section01.list.conparator.AscendingPrice;
...
public class Application02 {
    public static void main(String[] args){
        ...
        bookList.add(new BookDTO(3, "동의보감", "허준", 35000));
        bookList.add(new BookDTO(4, "삼국사기", "김부식", 36000));
        bookList.add(new BookDTO(5, "삼국유사", "일연", 55000));



        // Comparator 구현체를 구현하지 않아서 실행이 안 됨
        /*
...
//            }
//        });
        bookList.sort((BookDTO b1, BookDTO b2) -> b2.getTitle().compareTo(b1.getTitle())); // 축약해준 것
        for(BookDTO book : bookList){
            System.out.println(book);
        }
    }
