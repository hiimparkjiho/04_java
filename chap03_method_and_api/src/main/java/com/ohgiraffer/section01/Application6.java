...
public class Application6 {
    public static void main(String[] args){
        ...
        * void는 아무 반환값도 가지지 않겠다는 리턴어비에 사용할 수 있는 키워이다,
        * 반환값이 없는 경우 return을 생략해도 컴파일러가 자동으로 추가하지만,
        * 반환값이 있는 경우는 return 구문을 반드시 명시적으로 작성해주어야 한다.
        ...
        * 메소드 작성 후 호출을 해보면 아무런 변화가 없으나 호출을 한 것이다.
        ...
        System.out.println(returnValue + "잘 나옴?");

        Application6 app7;  // 메모리에 공간을 할당
        app7 = app6.appMethod();
