...
public class Application1 {
    public static void main(String[] args){
        ...
        *
        * 논리 연산자의 종류
        * 1. 논리 연결 연산자: 두 개의 피연산자를 가지는 이향 연산자이며, 연산자의 결함 방향은 왼쪽에서 오른쪽이다. 두 개의 논리식을 판단하여 참과 거짓을 판단
        *   1-1 &&(논리 AND) : 두 개의 논리식 모두 참일 경우 참을 반환, 둘 중 한개라도 거짓인 경우 거짓을 반환하는 연산자이다.
        *   1-2 ||(논리 OR) : 두 개의 논리식 중 하나라도 참일 경우 참을 반환하고 둘 다 거짓은 경우 거짓을 반환한다.
        *
        * 2. 논리 부정 연산자 : 피연산자가 하나의 단합연산자로, 피연산자의 결합 방향은 왼쪽에서 오른쪽이다.
        *   2-1 !(논리 NOT) : 논리식의 결과가 참이면 거짓 거짓이면 참을 반환한다.
        * */

//
//        System.out.println("true와 false의 논리 and 연산 : " + (true) && (true) );
//        System.out.println("false와 true의 논리 and 연산 : " + (num1 < num2 && num3 < num1));
//
//        System.out.println("true와 true의 논리 or 연산 : " + (num1 < num2 || num3 < num1));
//        System.out.println("true와 false의 논리 or 연산 : " + (num1 < num2 || num3 < num1));
//
//        System.out.println("true의 논리 not 연산 : " + !false);
//        System.out.println("false의 논리 not 연산 : " + !true);
