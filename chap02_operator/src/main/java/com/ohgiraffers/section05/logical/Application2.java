...
public class Application2 {
    public static void main(String[] args){
        ...
        * */
        ...
        int num1 = 55;
        System.out.println("1부터 100사이의 인지 확인: " + ((num1 > 1) && (num1 <= 100)));

        int num2 = 166;
        System.out.println("1부터 100사이인지 확인: " + ((num2 >= 1) && (num2 <= 100)));

        /*
        * 연산자의 우선순위를 고려한다면 논리 and 연산이 먼저 수행되기 때문에 괄호는 묶지 않아도 된다.
        * 하지만 연산자 우선순위를 디테일하게 학습하고 개발하는 개발자가 적은 현실로 논리적으로 먼저 실행하는 내용을 괄호로 묶어주는 게 좋다.
        * */
